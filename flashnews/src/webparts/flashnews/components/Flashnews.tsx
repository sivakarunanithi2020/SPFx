...
public webpartHide(){
 console.log("inside timer");
  var parentDiv = $('div[data-viewport-id^="WebPart.FlashnewsWebPart"]');
 // parentDiv.hide();
 console.log(parentDiv);
  parentDiv.replaceWith("");
  console.log(parentDiv);
  var parentDiv1 = $('div[data-viewport-id^="WebPart.FlashnewsWebPart"]');
 ...
 // $("#myWebPartID").css('display','none');
  ...
  // var kashi = $('div[data-viewport-id^="WebPart.FlashnewsWebPart"]').replaceWith  .parent('div').parent('div');
...
public HideWebPart(){
  ...
  //document.getElementById("idFlashNewsWP")
  var parentDiv = $('div[data-viewport-id^="WebPart.FlashnewsWebPart"]');
 // parentDiv.replaceWith("");
  console.log(parentDiv+"parentDIV");
  parentDiv.hide();
   var test = document.querySelector('[data-viewport-id^="WebPart.FlashnewsWebPart"]');
  console.log(test+"only id");
  //alert("test");
  var test2 = document.querySelector('[data-viewport-id^="WebPart.FlashnewsWebPart"]');
 // var test2 = document.querySelector('[data-sp-web-part-id^="13e679c7-2414-4faf-b5c8-5fa7"]');
  console.log(test2);
 ...
 // $("#idFlashNewsWP").hide();
  ...
  setTimeout(() => {this.webpartHide();}, 15000);
                ...
                {(this.state.itemstore.map((item,index) => (
                        <div>
                          <Popup trigger={<div>{item["Title"]}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*** </div>} position="right left">
                            <div style={{marginTop:'200px',marginLeft:'10px', maxWidth:'650px',backgroundColor:this.props.descbgcolor,color:this.props.descfgcolor,fontSize:this.props.descfontsize,fontFamily:this.props.descfontname}} dangerouslySetInnerHTML={{__html:item["Description"]}}/>
                          </Popup>
                        </div>
                          )))} 
            </Marquee>
